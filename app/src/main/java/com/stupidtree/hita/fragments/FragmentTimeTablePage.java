...
public class FragmentTimeTablePage extends BaseFragment implements BasicOperationTask.OperationListener<List> {
    ...
    public static FragmentTimeTablePage newInstance(int week) {
        Bundle b = new Bundle();
        b.putInt("week", week);
        FragmentTimeTablePage f = new FragmentTimeTablePage();
        f.setArguments(b);
        return f;
    }
                            ...
                            AlertDialog ad = new AlertDialog.Builder(getContext()).
                                    ...
                                    .setPositiveButton(R.string.button_confirm, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            ef.explode(v);
                                            new deleteEventsTask(FragmentTimeTablePage.this, ei).execute();
                                        }
                                    }).create();
                            ...
                            AlertDialog ad = new AlertDialog.Builder(getContext()).
                                    ...
                                    .setPositiveButton(R.string.button_confirm, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ExplosionField ef = ExplosionField.attach2Window(requireActivity());
                                            ef.explode(v);
                                            new deleteEventsTask(FragmentTimeTablePage.this, eventItems).execute();
                                        }
                                    }).create();
                            ad.setTitle(R.string.dialog_title_sure_delete);

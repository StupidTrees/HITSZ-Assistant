...
public class NewsLectureListAdapter extends RecyclerView.Adapter<NewsLectureListAdapter.LectureViewHolder> {
    ...
    public NewsLectureListAdapter(Context context, List<Map<String, String>> res){
        mContext = context;
...
//        }
        ...
        if(mBeans.get(i).get("picture")!=null&&!mBeans.get(i).get("picture").isEmpty()){
            ...
            Glide.with(mContext).load(mBeans.get(i).get("picture")).centerCrop().into(lectureViewHolder.picture);
        }else{

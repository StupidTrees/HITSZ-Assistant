...
public class NewsBulletinRecyclerAdapter extends RecyclerView.Adapter<NewsBulletinRecyclerAdapter.BulletinViewHolder> {
    List<Map<String,String>> mBeans;
    LayoutInflater mInflater;
    OnItemClickListener mOnItemClickListener;

    public NewsBulletinRecyclerAdapter(Context c, List<Map<String, String>> res){
        mBeans = res;

...
public class DormitoryListAdapter extends RecyclerView.Adapter <DormitoryListAdapter.FoodViewHolder>{

    LayoutInflater mInflater;
    List<Dormitory> mBeans;
    Context mContext;
    ...
    public interface OnNaviClickListener {
        void OnClick(Dormitory c);
    }
    public void setOnItemClickListener(OnItemClickListener x){
        this.mOnItemClickListener = x;

    }
    public DormitoryListAdapter(Context context, List<Dormitory> res){
    ...
    public FoodViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
       View v = mInflater.inflate(R.layout.dynamic_dormitory_item,viewGroup,false);
    ...
    class FoodViewHolder extends RecyclerView.ViewHolder{
        ...
        public FoodViewHolder(@NonNull View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.dormitory_name);
           rate = itemView.findViewById(R.id.dormitory_rate);
            button_navi = itemView.findViewById(R.id.dormitory_navi_button);
            card = itemView.findViewById(R.id.dormitory_card);
        }
    }
}
